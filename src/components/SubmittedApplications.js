              ...
              <li>
                ...
                <div>
                  ...
                  <input
                    ...
                    type="checkbox"
                    checked={
                      user.work_preference === "from_office" ? true : false
                    }
                  />
                  ...
                  <input
                    ...
                    type="checkbox"
                    checked={
                      user.work_preference === "from_home" ? true : false
                    }
                  />
                ...
                <div>
                  ...
                  <ul>
                    {user.skills.map((skill) => {
                      return (
                        <li>
                          {technologies[skill.id - 1].title} Years of
